...
htmlhelp_basename = u'mPythonX 帮助文档'
...
latex_documents = [
    (master_doc, 'mPythonX.tex', u'mPythonX 编程手册',
     'LabPlus', 'manual'),
]
...
man_pages = [
    (master_doc, u'mpythonX', u'mPythonX 编程手册',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mPythonXdocs', 'mPythonX docs Documentation',
     author, 'mPythonXdocs', 'One line description of project.',
     'Miscellaneous'),
]
