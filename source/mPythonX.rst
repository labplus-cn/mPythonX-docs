...
目前最新版本为0.2.1，支持Windows 7/8/10、Windows XP、与 Macos：

http://static.steamaker.cn/files/mPythonXSetup0.2.1.exe
(Win 7 / 8 / 10)

http://static.steamaker.cn/files/mPythonXSetup0.2.1_XP.exe
(Win XP)

http://static.steamaker.cn/files/mPythonX_0.2.1_mac.zip
(Mac OS)
