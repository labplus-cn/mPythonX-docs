...
掌控板BLE测试版本（在0.5.2基础上，额外提供了BLE测试固件与图形化案例）：

* http://static.steamaker.cn/files/mpythonx-0.6.0-b2-win.exe (Win 7 / 8 / 10)

* http://static.steamaker.cn/files/mpythonx-0.6.0-b2-mac.zip (Mac OS)
